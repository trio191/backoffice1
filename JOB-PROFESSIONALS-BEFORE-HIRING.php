                ...
                <div class="row pt-2">
                  <div class="col-lg-7 text-white">
                    ...
                    <div class="d-flex flex-wrap" style="margin-top:-10px">
                      ...
                      <span class="d-flex align-items-center justify-content-center text-nowrap  vertical-line" style="color:#00365E">
                        <i class="ti ti-calendar ti-xs me-2"></i>Posted on: 23 January 2022 </span>
                      <span class="d-flex align-items-center justify-content-center text-nowrap  vertical-line" style="color:#00365E">
                        <i class="ti ti-video ti-xs me-2"></i>Videos: 1 </span>
                      <span class="d-flex align-items-center justify-content-center text-nowrap" style="color:#00365E">
                        <i class="ti ti-photo ti-xs me-2"></i>Images: 4 </span>
                    </div>
                  </div>
                  <div class="col-lg-5" style="text-align: right;">
                    <button type="button" class="btn waves-effect waves-light" style="border-radius: 0px !important;color: #00365E;background: #fff;"> Bookmark </button>
                    <button type="button" class="btn waves-effect waves-light" style="border-radius: 0px !important;color: #00365E;background: #fff;"> Under analyssis </button>
                   <button type="button" class="btn waves-effect waves-light" style="border-radius: 0px !important; color: #fff; background: #5E8BF7;" onclick="showForm()"> Apply for this job 
                    </button>
                  </div>
                </div>
              </div>
                        ...
                        <div class="col-lg-3">
                          ...
                          <div class="card mb-2" style="border: 1px solid #C6D2E7;box-shadow: none !important;background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                            ...
                            <div class="d-flex flex-wrap">
                              <label class="badge bg-label-primary me-2 mb-2"> 4g </label>
                              <label class="badge bg-label-primary me-2 mb-2"> ANTIFOOLING </label>
                              <label class="badge bg-label-primary me-2 mb-2"> ANODES </label>
                              <label class="badge bg-label-primary me-2 mb-2"> ANTIFOOLING </label>
                            </div>
                          </div>
                          <button type="button" class="btn waves-effect waves-light" style="border-radius: 0px !important; color: #fff; background: #5E8BF7;" onclick="showForm()"> Apply for this job 
