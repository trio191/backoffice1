...
@section('content')
        ...
        <div class="container" style="max-width: 1200px; margin: 20px auto; padding: 0 20px; min-height:100vh">
            ...
            <div class="row">
                <form method="GET" action="{{ route('surveyor-dashboard.index') }}">
                    <div class="row">
                    ...
                    @foreach ($jobs as $job)
                        ...
                        <div class="col-md-4 d-flex justify-content-center">
                            <div class="card"
                                ...
                                <button class="btn" id="bookmarkButton-{{ $job->id }}" onclick="bookmarkJob({{ $job->id }})"
                                    style="
                                        color: {{ $isBookmarked ? '#007bff' : '#000' }};
                                        position: absolute; top: 10px; right: 10px;   font-size: 20px;  background-color: transparent; border: none; cursor: pointer;">
                ...
                .then(data => {
                    if (data.message) {
                        ...
                        if (data.message === 'Job bookmarked successfully') {
                            button.style.color = '#007bff;'; // Color for bookmarked
                        } else {
                            button.style.color = '#fff'; // Color for unbookmarked
                        }
                    }
                })
