                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-7" style="text-align: right;color: #00365E;">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="GET" action="{{ route('surveyor.dashboard.myjobs') }}"
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('surveyor.dashboard.myjobs', ['status' => 'Under Analysis']) }}">Under
                                                    Analysis</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('surveyor.dashboard.myjobs', ['status' => 'Hired']) }}">Hired</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('surveyor.dashboard.myjobs', ['status' => 'Rejected']) }}">Rejected</a>
                                            </li>
                                        </ul>

                                        <button type="button" class="btn " style="color: #9CAFD1;">
                                            <a href="{{ route('surveyor.dashboard.myjobs') }}">Reset</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div>
                                            <span
                                                ...
                                                @elseif ($item->status ==='Rejected')
                                                    ...
                                                    @else
                                                    bg-label-primary
                                                @endif "><small>{{ $item->status }}</small></span>
