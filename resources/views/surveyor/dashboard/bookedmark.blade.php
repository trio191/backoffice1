 ...
 <div class="content-wrapper">
     ...
     <nav class="navbar navbar-expand-lg navbar-light">
         <div class="container-fluid">
             <ul class="navbar-nav">
                 <li class="nav-item">
                     <a class="nav-link" href="{{route('surveyor-dashboard.index')}}">Available jobs</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" href="{{ route('surveyor.dashboard.myjobs') }}">My Jobs</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" href="{{route('surveyor-bookedmark.jobs')}}">Bookmarked</a>
                 </li>
             </ul>
         </div>
     </nav>
            ...
            <div class="row">
                <div class="col-md-12 d-flex" style="gap: 0; width: 80%;">
                    ...
                    <select name="type_skill" class="form-select" style="width: 300px;">
                        ...
                        <option {{ request('type_skill') == 'surveyor' ? 'selected' : '' }}>surveyor</option>
         ...
         <div class="row">
            ...
            @if ($jobs->isEmpty() )
             <div class="col-md-12 text-center">
                <div class="job-card">
                    <p>
                        Sorry no job added to Book Marked
                    </p>
                </div>
             </div>
             @endif
