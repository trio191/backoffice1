                     ...
                     <div class="col-lg-12">
                         <div class="row">
                             ...
                             <div class="col-lg-8" style="text-align: right;color: #00365E;">
                                 <div class="row">
                                     <div class="col-lg-5">
                                         <form method="GET" action="{{ route('surveyor-reports.search') }}">
                                             @csrf
                                         ...
                                         <div class="d-flex flex-wrap">
                                                 ...
                                                 <ul class="dropdown-menu">
                                                     @foreach ($report_types as $item)
                                                         <li><a class="dropdown-item" 
                                                            href="{{ route('surveyor-reports.index', array_merge(request()->all(), ['report_id' => $item->id])) }}">
                                                             {{ $item->name }}
                                                         </a>
                                                         </li>
                                                     @endforeach
                                             ...
                                             <div class="dropdown">
                                                 ...
                                                 <ul class="dropdown-menu">
                                                     @foreach ($jobs as $item)
                                                         <li> <a class="dropdown-item" 
                                                            href="{{ route('surveyor-reports.index', array_merge(request()->all(), ['job_id' => $item->id])) }}">
                                                             {{ $item->job_title }}
                                                         </a>
                                                         </li>
                                                     @endforeach
                                             ...
                                             <button type="button" class="btn waves-effect waves-light"
                                                 aria-expanded="false" style="color: #00365E;">
                                               <a href="{{route('surveyor-reports.index')}}">
                                                 Reset</a>
                                             </button>
                                         </div>
                                     </div>
