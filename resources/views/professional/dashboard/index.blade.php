...
@section('content')
        ...
        <div class="container" style="max-width: 1200px; margin: 20px auto; padding: 0 20px; min-height:100vh">
            ...
            <div class="row">
                <form method="GET" action="{{ route('professional-dashboard.index') }}">
                    <div class="row">
                ...
                <div style="display: flex; gap: 10px; margin-bottom: 20px; flex-wrap: wrap;">
                    ...
                    @if (
                        ...
                        <a href="{{ route('professional-dashboard.index') }}"
                    ...
                    @foreach ($jobs as $job)
                        ...
                        <div class="col-md-4 d-flex justify-content-center">
                            <div class="card"
                                ...
                                <button id="bookmarkButton-{{ $job->id }}" onclick="bookmarkJob({{ $job->id }})" class="btn"
                                    style=" color: {{ $isBookmarked ? '#007bff' : '#000' }}; position: absolute; top: 10px; right: 10px; font-size: 20px; background-color: transparent; border: none; cursor: pointer;">
                                ...
                                <div class="card-body" style="padding: 15px;">
                                    <!-- Date and Job Type -->
                                    <a href="{{route('professional-jobs.show',$job->id)}}">
    ...
    <script>
        function bookmarkJob(jobId) {
            fetch("{{ route('professional-bookedmark.jobs.store') }}", {
                    method: "POST",
                    headers: {
