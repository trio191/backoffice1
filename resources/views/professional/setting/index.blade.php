            ...
            <div class="nav-align-top  mb-4">
                ...
                <div class="tab-content" style="margin-left: -20px;margin-right: -20px">
                    <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                        <form method="POST" action="{{ route('professional-setting.update', $user->id) }}"
                                    ...
                                    <div class="col-lg-12 mt-5" style="color: #00365E">
                                        ...
                                        <div class="alert alert-secondary" style="border-radius: 0px">
                                            <p class="mb-0 d-flex" style="color: #00365E">
                                                ...
                                                <span style="font-size: 16px;">Professional </span>
                                            </p>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group" style="position: relative;">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="professionalDetails[country]"
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group" style="position: relative;">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="professionalDetails[state]"
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group" style="position: relative;">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="professionalDetails[postalCode]"
                                                        value=" {{ $professionalDetails['postalCode'] ?? '' }}">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group" style="position: relative;">
                                                    <input type="text" class="form-control" placeholder="Enter Address"
                                                        style="border-radius:0px" name="professionalDetails[address]"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                @if(isset($professionalDetails['servicesProvided']))
                                                    @php
                                                        // Decode the `servicesProvided` string into an array
                                                        $services = json_decode($professionalDetails['servicesProvided'], true);
                                                    @endphp
                                                    @if(!empty($services))
                                                        @foreach($services as $service)
                                                            <span class="badge bg-light text-dark me-2 mb-2" style="border: 1px solid #ddd; padding: 8px 12px; border-radius: 5px;">
                                                                {{ $service }}
                                                                <i class="ti ti-x ms-2" style="cursor: pointer;"></i>
                                                            </span>
                                                        @endforeach
                                                    @else
                                    ...
                                    <div class="card mb-2"
                                        ...
                                        <div class="d-flex"
                                            ...
                                            <input class="w-100" type="text" style="border: none !important"
                                                placeholder="facebook URL" name="professionalDetails[facebookUrl]">
                                        </div>
                                        <div class="d-flex mt-2"
                                            style="border: 1px solid #C6D2E7;border-radius: 0px;background: #fff;text-align: left;padding: 10px;">
                                            <i class="ti ti-brand-linkedin ti-sm"></i>
                                            <input class="w-100" type="text" placeholder="LinkedIn URL"
                                                style="border: none !important" name="professionalDetails[linkedinUrl]">
                                        </div>
                                    </div>
                                    <div class="card mb-2"
                                        style="border: 1px solid #C6D2E7;box-shadow: none !important;background: url('assets/img/card-corner2.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                                    ...
                                    <form method="POST" action="{{ route('professional-setting.update', $user->id) }}">
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group" style="position: relative;">
                                                    <input type="text" class="form-control"
                                                        style="border-radius:0px" placeholder="1234" name="professionalDetails[postCode]"
                                                        value="{{ $professionalDetails['postalCode'] ?? '' }}  "
                                                        >
                                                    <label class="labelOwn">Post Code</label>
                                                </div>
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group" style="position: relative;">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="professionalDetails[address]"
                                                         value="{{ $professionalDetails['address'] ?? '' }}  "
                                                        >
                                                        <label class="labelOwn">address</label>
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group" style="position: relative;">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        >
                                                        <label class="labelOwn">Phone</label>
