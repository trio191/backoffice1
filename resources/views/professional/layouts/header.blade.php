        ...
        <div class="navbar-nav align-items-center">
            <div class="nav-item navbar-search-wrapper mb-0">
                <a class="nav-item nav-link  d-flex align-items-center px-0" href="">
                    ...
                    <span class="d-none d-md-inline-block me-2" style="color:#00365E">Professional Dashboard</span>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ Auth::user()->profile_image ? Auth::user()->profile_image : asset('dashboard/assets/img/profile.jpg') }}" alt class="h-auto rounded-circle" />
                    </div>
                </a>
                    ...
                    <li>
                        <a class="dropdown-item" href="#">
                            <center>
                                <div class="">
                                    <div class="avatar ">
                                        <img src="{{ Auth::user()->profile_image ?   Auth::user()->profile_image : asset('dashboard/assets/img/profile.jpg') }}" alt
