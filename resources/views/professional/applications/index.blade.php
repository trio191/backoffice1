                        ...
                        <div class="card"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-info">
                                    ...
                                    <h5 class="mb-0" style="color: #00365E">{{ $applications->count() }}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <form method="GET" action="{{ route('professional-applications.index') }}">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <button type="button" class="btn waves-effect waves-light"
                                                style="color: #00365E;">
                                                <a href="{{ route('professional-applications.index') }}">Reset</a>
                                            </button>
                                        </div>
                                    </div>
                                </div>
