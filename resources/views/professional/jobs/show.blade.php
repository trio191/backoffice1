            ...
            <div class="col-lg-12" style="margin-top: -24px">
                <div class="nav-align-top  mb-4">
                    ...
                    <div class="tab-content" style="margin-left: -20px;margin-right: -20px">
                        ...
                        <!-- Form -->
                        <div id="slideForm">
                            <form method="post" action="{{route('professional-applications.store')}}" class="needs-validation" novalidate>
                              @csrf
                              @method('post')
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input type="number" name="materialCost" class="form-control" id="materialCost"
                                                placeholder="EUR Material cost" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <form class="input-group input-group-merge" method="get" action="{{ route('professional-jobs.show', $job->id) }}">
                                                ...
                                                <tr class="border" style="color:#00365E;font-size: 14px;">
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-wrap">
                                                            ...
                                                            <span style="font-size: 12px;padding-top: 4px;">{{$item->message}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex flex-wrap">
