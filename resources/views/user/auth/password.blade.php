            ...
            <div class="col-12 col-xl-8 px-0 right-side">
                <div class="px-5 col-12 py-3">
                    ...
                    <div class="col-12 px-0">
                        <label for="inputState" style="font-family: Poppins; font-size: 18px; font-weight: 400; line-height: 36px; letter-spacing: 0.5px; text-align: left; color: #00365E;">Password</label>
                    </div>
                    <form>
                    ...
                    <div id="passwordRules" class="col-12 innerFormBg py-2 px-3">
                        <p class="py-2" style="font-family: Poppins; font-size: 16px; font-weight: 400; line-height: 30px; letter-spacing: 0.5px; color: #00365E;">
                    ...
                    <div class="row mt-5 d-flex align-items-center">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <button  type="submit" id="submitBtn" class="border-0 d-flex align-items-center text-white px-4 py-1" style="background-color: #5E8BF7;">
    ...
    <script>
        $(document).ready(function() {
            $('#inputPassword, #confirmPassword').on('input', function() {
                ...
                $('#uppercaseRule, #lowercaseRule, #specialCharsRule, #numericRule, #lengthRule').removeClass('text-success').addClass('text-danger');
                    ...
                    if (password === confirmPassword && confirmPassword !== '') {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                $('#btn-loading').removeClass('disabled').html('loading...');
