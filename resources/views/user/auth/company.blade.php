...
<body>
        ...
        <div class="row">
            ...
            <div class="col-xl-8 right-side-addlink justify-content-center" style="height: 100%;">
                <div class="px-5 py-3">
                    ...
                    <h2 class="" style="color: #00365E;">Create account as <span style="color: #5E8BF7;">Company</span> </h2>
                    ...
                    <form id="registration-form">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="error-message" data-error="companyName"></div>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" id="companyUrl" name="companyUrl" placeholder="Company Url*">
                                <div class="error-message" data-error="companyUrl"></div>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="email" class="form-control" id="companyEmail" name="companyEmail" placeholder="Company email*">
                                <div class="error-message" data-error="companyEmail"></div>
                            </div>
                            <div class="form-group col-md-6">
    ...
    $(document).ready(function() {
        ...
        var companys = JSON.parse(localStorage.getItem('company')) || {};
        ...
        Object.keys(fields).forEach(function(key) {
            ...
            $('#registration-form').on('submit', function(e) {
                ...
                if ($('#companyUrl').val().trim() === '') {
                    ...
                    isValid = false;
                } else if (!urlPattern.test($('#companyUrl').val().trim())) {
                ...
                if ($('#companyEmail').val().trim() === '') {
                    ...
                    isValid = false;
                } else if (!emailPattern.test($('#companyEmail').val().trim())) {
