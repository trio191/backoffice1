...
<body>
            ...
            <div class="col-xl-8  right-side-addlink justify-content-center">
                <div class="">
                    <div class="px-5 py-3">
                        ...
                        <h3 class="heading-text" style="font-family: Cormorant Garamond;color: #00365E;">Create account as <span style="color: #5E8BF7;">Captain/Chief-Engineer</span></h3>
    ...
    <script>
        $(document).ready(function() {
           // Retrieve and parse the chief engineer data from localStorage
            var chiefEngineers = JSON.parse(localStorage.getItem('chiefEngineer')) || {};
            ...
            Object.keys(fields).forEach(function(key) {
                $(fields[key]).val(chiefEngineers[key] || '');
            });


            $('#registration-form').on('submit', function(e) {
                e.preventDefault();
                window.location.href = "/register/addYachatCaptain";
                var chiefEngineer = {
                    country:  $('#country').val(),
                    state:  $('#state').val(),
                    city:  $('#city').val(),
                ...
                localStorage.setItem('chiefEngineer', JSON.stringify(chiefEngineer));
            });
        });
    </script>
</body>
