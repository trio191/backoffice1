                                ...
                                <div class="card-info">
                                    <small style="font-size: 11px">Last activity</small>
                                        <h5 class="mb-0" style="color: #2AD7B3"> 
                                            @if ($teams->isNotEmpty())
                                            {{ \Carbon\Carbon::parse($teams->last()->created_at)->format('d M Y') }} 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6" style="text-align: right;color: #00365E;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <form action="{{ route('captain-team.index') }}" method="GET"
                                        ...
                                        <div class="card"
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="mx-auto my-">
                                                    <div class="mx-auto my-"> 
                                                        <img 
                                                            src="{{ $item->picture ? asset($item->picture) : asset('dashboard/assets/img/profile.jpg') }}"
                                                            alt="Avatar Image" 
        ...
        $('#submitTeamMember').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Reset form fields
                    $('#teamMemberForm2')[0].reset(); // Reset form fields
                    $('#selectpickerIcons').selectpicker('refresh'); // Refresh selectpick

                    $('#offcanvasEnd').modal('hide'); // Close the modal
                },
                error: function(xhr, status, error) {
                    // Check if the server responded with validation errors
                    if (xhr.status === 422) { // 422 is HTTP code for validation errors
                        var errors = xhr.responseJSON
                        .errors; // Get errors from the response

                        // Iterate over the errors and display them next to the corresponding fields
                        for (var field in errors) {
                            if (errors.hasOwnProperty(field)) {
                                // Find the corresponding field and display the error
