        ...
        <form id="jobForm" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-md-12 mb-4">
                ...
                <div class="form-group mt-3" style="position: relative;">
                    <input type="text" class="form-control" id="jobTitle" name="job_title" style="border-radius:0px"
                        placeholder="What is the purpose of this job?">
            ...
            <div class="col-md-12 mb-4">
                ...
                <div class="form-group mt-3" style="position: relative;">
                    <textarea class="form-control" id="jobDescription" name="job_description" style="border-radius:0px" rows="5"
                        placeholder="Please describe the issue or present additional details for the professional"></textarea>
            ...
            <div class="col-md-12 mb-2">
                ...
                <select class="form-control" id="requireSurveyor" name="require_surveyor"
                    style="border-radius: 0px !important;">
                    <option>select surveyors status</option>
            ...
            <div class="col-md-12 mb-2 mt-4">
                ...
                <div class="col-md-12 mb-2 mt-2">
                    <select class="form-control " id="requireflexiblity" name="budget_flexible"
                        style="border-radius: 0px !important">
                        <option>select budget flexiblity</option>
            ...
            <div class="col-md-12 mb-4">
                ...
                <div class="input-group input-group-merge" style="border-radius: 0px !important">
                    ...
                    <input type="date" class="form-control flatpickr-input" id="deliveryDate" name="delivery_date"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#jobForm").on('submit', function(e) {
            ...
            if (validateForm()) {
                ...
                $.ajax({
					url: "{{ route('captain-jobs.store') }}", // Ensure the route points to the correct one
                    type: 'POST',
                    data: formData,
                    ...
                    success: function(response) {
                        ...
                        setTimeout(function() {
                            location.reload();  // Reload after a successful submission
    ...
    function validateForm() {
        ...
        if (!imageFile || !imageFile.type.startsWith("image/")) {
            $('.img-alert').html('Please upload a valid image.');
            isValid = false;
        } else {
            $('.img-alert').html('.'); // Clear error message if valid
        }
        return isValid;
    }
