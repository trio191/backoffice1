                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-8" style="text-align: right;color: #00365E;">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <form method="GET" action="{{ route('captain-reports.index') }}"
                            ...
                            <table class="table table-responsive">
                                ...
                                @foreach ($reports as $item)
                                    <tr data-bs-toggle="offcanvas" data-bs-target="#jobReport" aria-controls="jobReport"
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap">
                                                <div class="avatar me-2">
                                                    <img src="{{ asset('dashboard/assets/assets/img/avatars/5.png') }}"
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap">
                                                <img src="{{ asset('dashboard/assets/assets/img/yacht-black.png') }}"
