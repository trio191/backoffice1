        ...
        <div class="navbar-nav align-items-center">
            <div class="nav-item navbar-search-wrapper mb-0">
                <a class="nav-item nav-link  d-flex align-items-center px-0" href="">
                    ...
                    <span class="d-none d-md-inline-block me-2" style="color:#00365E">Captain Dashboard</span>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        ...
                        {{-- <img src="/dashboard/assets/assets/img/avatars/1.png" alt class="h-auto rounded-circle" /> --}}

                        <img src="{{ asset(Auth::user()->profile_image) }}" alt class="h-auto rounded-circle" />
                    ...
                    <li>
                        <a class="dropdown-item" href="#">
                            <center>
                                <div class="">
                                    <div class="avatar ">
                                        <img src="{{ asset(Auth::user()->profile_image) }}" alt style="width: 50px;height: 50px;"  class="h-auto rounded-circle" />

                                        {{-- <img src="/dashboard/assets/assets/img/avatars/1.png" alt
                                    ...
                                    <label style="font-size: 13px;color: #5E8BF7;">Captain - Admin</label>
                                </div>
                            </center>
                        </a>
                    </li>
