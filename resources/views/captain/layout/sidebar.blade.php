...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme"
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active">
            <a href="{{ route('captain-dashboard.index') }}" class="menu-link ">
        ...
        <li class="menu-item ">
            <a href="{{ route('captain-yachts.index') }}" class="menu-link ">
        ...
        <li class="menu-item ">
            <a href=" {{ route('captain-team.index') }} " class="menu-link ">
        ...
        <li class="menu-item ">
            <a href="{{ route('captain-jobs.index') }}" class="menu-link ">
        ...
        <li class="menu-item ">
            <a href="{{ route('captain-applications.index') }}" class="menu-link ">
                <i class="menu-icon tf-icons ti ti-file-export"></i>
                <div data-i18n="Applications">Applications</div>

                @if (Application::join('job_posts', 'applications.job_id', '=', 'job_posts.id')
                ->where('job_posts.user_id', Auth::user()->id)
                ->where('applications.status', 'Under Analysis')
                ->exists())
            <div class="badge rounded-pill ms-auto" style="border: 1px solid #FFFFFF;">
                {{
                    Application::join('job_posts', 'applications.job_id', '=', 'job_posts.id')
                        ->where('job_posts.user_id', Auth::user()->id)
                        ->where('applications.status', 'Under Analysis')
                        ->count()
                }}
        ...
        <li class="menu-item ">
            <a href="{{ route('captain-reports.index') }}" class="menu-link ">
                <i class="menu-icon tf-icons ti ti-file-analytics"></i>
                <div data-i18n="Reports">Reports</div>
                @if (Report::where('reporter_id', Auth::user()->id)->exists())
                    <div class="badge rounded-pill ms-auto" style="border: 1px solid #FFFFFF;">
                        {{ Report::where('reporter_id', Auth::user()->id)->count() }}
                    </div>
                @endif
        ...
        <li class="menu-item">
            <a href="{{ route('captain-settings.index') }}" class="menu-link">
        ...
        <div class="col-lg-12 p-4 mt-5">
            <div class="overlay-container"
                ...
                <button class="btn btn-outline-white w-100"
