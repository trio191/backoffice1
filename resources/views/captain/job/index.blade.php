                ...
                <div class="row pt-2">
                    ...
                    <div class="col-lg-5" style="text-align: right;">
                        <button type="button" data-bs-toggle="offcanvas" data-bs-target="#createJob"
                            aria-controls="createJob" class="btn btn-white waves-effect waves-light" type="button"
                    ...
                    <div class="col-lg-12 ">
                        <div class="row py-3">
                            ...
                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                <form class="row" method="get" action="{{ route('captain-jobs.index') }}">
                                    <div class="col-lg-7">
                        ...
                        <div class="col-lg-12 mb-3 mt-4 p-5 text-center" style="border: 1px solid #C6D2E7;padding: 20px">
                                <p>
                                    No Job 
                                </p>
                        </div>
