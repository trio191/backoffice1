                ...
                <div class="nav-align-top  mb-4">
                    ...
                    <div class="tab-content" style="margin-left: -20px;margin-right: -20px">
                        <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                            <form method="POST" action="{{ route('captain-settings.update', $user->id) }}"
                                        ...
                                        <div class="col-lg-12 mt-5" style="color: #00365E">
                                            ...
                                            <div class="alert alert-secondary" style="border-radius: 0px">
                                                <p class="mb-0 d-flex" style="color: #00365E">
                                                    ...
                                                    <span style="font-size: 16px;">Captain </span>
                                                </p>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="captainDetails[country]"
                                                            value=" {{ $captainDetails['country'] ?? '' }}">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="captainDetails[state]"
                                                            value="{{ $captainDetails['state'] ?? '' }}">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Something"
                                                            name="captainDetails[city]"
                                                            value=" {{ $captainDetails['city'] ?? '' }}">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="captainDetails[postalCode]"
                                                            value=" {{ $captainDetails['postalCode'] ?? '' }}">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" name="captainDetails[address]"
                                                            value=" {{ $captainDetails['address'] ?? '' }}">
                                        ...
                                        <div class="card mb-2"
                                            ...
                                            <div class="d-flex"
                                                ...
                                                <input class="w-100" type="text" style="border: none !important"
                                                    placeholder="facebook URL" name="captainDetails[facebookUrl]">
                                            </div>
                                            <div class="d-flex mt-2"
                                                style="border: 1px solid #C6D2E7;border-radius: 0px;background: #fff;text-align: left;padding: 10px;">
                                                <i class="ti ti-brand-linkedin ti-sm"></i>
                                                <input class="w-100" type="text" placeholder="LinkedIn URL"
                                                    style="border: none !important" name="captainDetails[linkedinUrl]">
                                            </div>
                                        </div>
                                        <div class="card mb-2"
                                            style="border: 1px solid #C6D2E7;box-shadow: none !important;background: url('assets/img/card-corner2.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                                        ...
                                        <form method="POST" action="{{ route('captain-settings.update', $user->id) }}">
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="1234" name="captainDetails[postCode]"
                                                            value="{{ $captainDetails['postCode'] ?? '' }}  "
                                                            >
                                                        <label class="labelOwn">Post Code</label>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="captainDetails[phoneNumber]"
                                                             value="{{ $captainDetails['phoneNumber'] ?? '' }}  "
                                                            >
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="captainDetails[companyName]"
                                                            value="{{ $captainDetails['companyName'] ?? '' }}  "
                                                            >
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="captainDetails[companyRegVat]"
                                                            value="{{ $captainDetails['companyRegVat'] ?? '' }}  "
                                                            >
