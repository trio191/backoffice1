                ...
                <div class="row pt-2">
                    ...
                    <div class="col-lg-5" style="text-align: right;">
                        ...
                        <button type="button" data-bs-toggle="offcanvas" data-bs-target="#createJob"
                            aria-controls="createJob" type="button" class="btn btn-white waves-effect waves-light"
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                <form action="{{ route('owner/job') }}" method="GET">
                                    @csrf
                                    <div class="row">
                                        <!-- Search Bar -->
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="me-2">
                                                    <select class="form-select border-0" name="status"
                                                        onchange="this.form.submit()" style="color: #00365E;">
                                                        ...
                                                        <option value="hired"
                                                            {{ request('status') == 'hired' ? 'selected' : '' }}>Hired
                                                        </option>
                                                ...
                                                <button type="button" class="btn"
                                                    onclick="window.location.href='{{ route('owner/job') }}'"
                                                    style="color: #9CAFD1;">
                                                    Reset
                                                </button>
                                            </div>
                        ...
                        @foreach ($jobs as $item)
                            @if ($item->status == 'approved')
                                <div class="col-lg-12 mb-3 mt-4" style="border: 1px solid #C6D2E7;padding: 20px">
                                    <a href="{{ route('owner.job.details', $item->id) }}">
                                        <div class="row">
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-9" style="color:#00365E">
                                                ...
                                                <p style="margin-top:-15px;font-size:12px;">
                                                    {{ Str::words($item->job_description, 30, '...') }}</p>
                                            ...
                                            <div class="col-lg-7" style="margin-top: -5px">
                                                <div class="d-flex flex-wrap" style="margin-top: -7px">
                                                    <div class="avatar me-3">
                                                        <img src="{{asset( $item->user->profile_image) }}"
                                        ...
                                        <div class="col-lg-6 " style="border-right: 1px solid #9CAFD1;">
                                            <div class="d-flex flex-wrap ">
                                                ...
                                                <span style="font-size: 14px;" class="me-2">up to
                                                    {{ $item->budget }}€</span>
                                                <span class="badge"
                                                    style="background: #2AD7B30D;color: #1CBDA0;">Flexible</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-5" style="color:#1CBDA0">
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <span style="font-size: 14px;"
                                                    class="me-2">{{ $item->applications->count() }}</span>
                            ...
                            @elseif ($item->status == 'waiting')
                                <div class="col-lg-12 mb-3" style="border: 1px solid #C6D2E7;padding: 20px">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9" style="color:#00365E">
                                            <div class="row">
                                                <a class="text-dark" href="{{ route('owner.job.details', $item->id) }}">
                                                    <div style="display: flex">
                                            ...
                                            <p style="" class="mt-1">{{ $item->job_title }}</p>
                                            <p style="margin-top:-15px;font-size:12px;">
                                                {{ Str::words($item->job_description, 30, '...') }}
                                            </p>
                                            </a>
                                        </div>
                                        <div class="col-lg-1" style="text-align: right;">
                                        ...
                                        <div class="col-lg-7" style="margin-top: -5px">
                                            <div class="d-flex flex-wrap" style="margin-top: -7px">
                                                <div class="avatar me-3">
                                                    <img src="{{asset( $item->user->profile_image) }}" alt="Avatar"
                                                        class="rounded-circle">
                                                </div>
                                                <div>
                                                    <p class=" mt-2" style="font-size: 14px;color: #00365E;">
                                                        {{ $item->user->firstName }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 " style="text-align: right;margin-top: -15px">
                                            <button class="btn btn-sm"\ onclick="approveJob({{ $item->id }});"
                                                style="background-color:#5E8BF7;color: white;border-radius: 0px;">Approve</button>
                                        </div>
                                    </div>
                                    <div class="row mt-1"
                                        style="border-top: 1px solid #C6D2E7;margin-left: -20px;margin-right: -20px;padding: 15px;padding-bottom: 0px !important;color: #00365E;">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="d-flex flex-wrap">
                                                ...
                                                {{ isset($item->delivery_date) ? $item->delivery_date->format('j M Y') : '' }}
                                    ...
                                    <div class="row mt-1"
                                        ...
                                        <div class="col-lg-3" style="border-right: 1px solid #9CAFD1;">
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <span style="font-size: 14px;" class="me-2">
                                                    {{ $item->reports->where('reportType.name', 'Surveyor')->count() }}
                                                </span>
                                        ...
                                        <div class="col-lg-3" style="border-right: 1px solid #9CAFD1;">
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <span style="font-size: 14px;" class="me-2">
                                                    {{ $item->reports->where('reportType.name', 'Progress')->count() }}
                                                </span>
                                        ...
                                        <div class="col-lg-3 text-danger">
                                            <div class="d-flex flex-wrap">
                                                <i class="ti ti-calendar me-2"></i>
                                                <span style="font-size: 14px;" class="me-2">Incedents:</span>
                                                <span style="font-size: 14px;" class="me-2">
                                                    {{ $item->reports->where('reportType.name', 'Incident')->count() }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12 mb-4" style="border: 1px dashed #5E8BF7;height: 156px;padding: 20px;">
                            <center data-bs-toggle="offcanvas" data-bs-target="#createJob"
                            aria-controls="createJob">
