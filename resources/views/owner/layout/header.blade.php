            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        ...
                        @else
                            <img src="{{ asset('dashboard/assets/img/profile.jpg') }}" alt="Default Profile Image"
                                class="h-auto rounded-circle" />
                        @endif
                                    ...
                                    <div class="avatar ">
                                        @if (Auth::user()->profile_image)
                                            <img src="{{ asset(Auth::user()->profile_image) }}"
                                                alt="Profile Image" class="h-auto rounded-circle" />
                                        @else
                                            <img src="{{ asset('dashboard/assets/img/profile.jpg') }}"
                                                alt="Default Profile Image" class="h-auto rounded-circle" />
                                        @endif


                                    </div>
                                    <label class="mt-3"
                                        style="color:#00365E;font-size: 16px;">{{ Auth::user()->firstName }}
                                        {{ Auth::user()->lastName }}</label><br>
