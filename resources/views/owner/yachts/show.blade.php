                ...
                <div class="row">
                    ...
                    <div class="col-lg-5" style="text-align: right;">
                        ...
                        <button type="button" data-bs-toggle="offcanvas" data-bs-target="#createJob"
                            ...
                            <span class="ti-xs ti ti-briefcase me-1"></span>Create Job
                        </button>

                        <div class="dropdown mt-1 ml-2" style="z-index: 1050; position: relative;">
                            ...
                            <ul class="dropdown-menu" style="z-index: 1055;">
                                <li data-bs-toggle="offcanvas" data-bs-target="#createJob"
                                aria-controls="createJob"><a class="dropdown-item" href="#">Create a Job</a></li>

                                <li data-bs-toggle="offcanvas" data-bs-target="#offcanvasEnd"
                                aria-controls="offcanvasEnd"><a class="dropdown-item" href="#">Invite a Crew</a></li>
                                <li onclick="deleteYacht({{ $yachtData->id }});">
                                    <a class="dropdown-item" href="#">Delete Yacht</a>
                                </li>
                            </ul>
                    ...
                    <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-lg-8 mt-5">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('show.owner.yacht', ['id' => $yachtData->id, 'status' => 'approved']) }}">Approved</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('show.owner.yacht', ['id' => $yachtData->id, 'status' => 'waiting']) }}">Waiting</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('show.owner.yacht', ['id' => $yachtData->id, 'status' => 'hired']) }}">Hired</a>
                                                    </li>
                                ...
                                @if ($jobs->isEmpty())
                                    <div class="col-lg-12 mb-3 text-center p-5"
                                        style="border: 1px solid #C6D2E7;padding: 20px">
                                                    ...
                                                    <div class="d-flex flex-wrap">
                                                        ...
                                                        @if ($job->status == 'waiting')
                                                            ...
                                                            <span style="font-size: 14px;"
                                                                class="me-2"> {{ isset($job->delivery_date) ? $job->delivery_date->format('j M Y') : '' }}</span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <form class="input-group input-group-merge" method="get"
                                                        action="{{ route('show.owner.yacht', $yachtData->id) }}">
                                                        <span class="input-group-text" id="basic-addon-search31"><i
                                                                class="ti ti-search"></i></span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Search..." name="job_search"
                                                            onchange="this.form.submit()"
                                                            value="{{ request('job_search') }}" aria-label="Search..."
                                        ...
                                        <div class="col-lg-12 my-3" style="border: 1px solid #C6D2E7;padding: 20px">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9" style="color:#00365E">
                                                    <a href="{{ route('owner.job.details', $job->id) }}">
                                                        <div class="row">
                                                            <div style="display: flex">
                                                                ...
                                                                <span class="me-2 vertical-line"
                                                                    style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">
                                                                    <img src="/dashboard/assets/img/yacht.png"
                                                                        class="me-1" />{{ $job->yacht->yachtName }}
                                                                </span>
                                                                <span class="me-2 vertical-line"
                                                                    style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">
                                                                    @if ($job->require_surveyor == 'yes')
                                                        ...
                                                        <p style="" class="mt-1 text-dark">{{ $job->job_title }}
                                                        </p>
                                                        <p class=" text-dark" style="margin-top:-15px;font-size:12px;">
                                            ...
                                            <div class="row mt-1"
                                                ...
                                                @if ($job->status != 'hired')
                                                    ...
                                                    <div class="col-lg-5" style="color:#1CBDA0">
                                                        <div class="d-flex flex-wrap">
                                                            <i class="fa fa-file-export me-2"
                                    ...
                                    <div class="card"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info">
                                                <small style="font-size: 11px">Total Invested</small>
                                                <h5 class="mb-0" style="color: #00365E">
                                                    {{ $jobs->where('status', 'approved')->sum('budget') }} €</h5>
                                        ...
                                        <table class="table table-responsive">
                                            ...
                                            @foreach ($reports as $item)
                                                <tr class="border" style="color:#00365E;font-size: 14px;">
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-wrap">
                                                            <img src="/dashboard/assets/img/yacht-black.png"
                                                ...
                                                <div class="document-box">
                                                    <div class="small mb-2">
                                                        Current File: <a target="_blank"
                                                            href=" {{ $yachtData->document }}"> View Document
                                                        </a> <br>
        ...
        function deleteYacht(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    alert(response.message || "Yacht deleted successfully.");
                    // Optionally remove yacht from the DOM
                    window.location.href = '/owner/yachets';
