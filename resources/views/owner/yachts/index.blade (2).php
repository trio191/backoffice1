                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <form class="input-group input-group-merge" action="{{ route('/owner/yachets') }}"
                                            method="GET">
                                                    ...
                                                    @foreach ($reportTypes as $item)
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('/owner/yachets') }}?search={{ request('search') }}&report_type_id={{ $item->id }}">
                                                                {{ $item->name }}
                                                            </a>
                                                        </li>
                                                    @endforeach
                        ...
                        @foreach ($yachts as $yacht)
                            <div class="col-lg-12 mb-3 mt-5" style="border: 1px solid #C6D2E7;">
                                <a href="{{ route('show.owner.yacht', $yacht->id) }}">
                                    <div class="row">
                                        <div class="col-lg-2">
                                                ...
                                                <div class="col-lg-12 mt-3">
                                                    <div class="row mt-1"
                                                        ...
                                                        <div class="col " style="border-right: 1px solid #9CAFD1;">
                                                            ...
                                                            <label style="font-size: 18px;" class="me-2 mt-1">
                                                                {{ $yacht->jobPost->sum(function ($job) {
                                                        ...
                                                        <div class="col " style="border-right: 1px solid #9CAFD1;">
                                                            ...
                                                            <label style="font-size: 18px;color: #FF005C;"
                                                                class="me-2 mt-1">
                                                                {{ $yacht->jobPost->sum(function ($job) {
                                                                    return $job->reports->where('reportType.name', 'Incident')->count();
                                                                }) }}

                                                                {{-- {{$jobs->pluck('reports')->flatten()->where('reportType.name', 'Incident')->count()}} --}}
                                                            </label>
                                                        </div>
                                                        <div class="col ">
                                                            <div class="d-flex flex-wrap ">
