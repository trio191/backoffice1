...
@section('content')
@include('owner.components.add-yachets')
<div class="content-wrapper">
  <!-- Content -->
  <div class="layout-demo-wrapper" style="background-image: url('/dashboard/assets/img/bg.png'); height: 100px; background-size: 100% 100%; padding-top: 20px; position: relative;padding-bottom: 20px;">
      ...
      <div class="row pt-2">
        ...
        <div class="col-lg-5" style="text-align: right;">
          <button type="button" data-bs-toggle="offcanvas" data-bs-target="#addYacht" aria-controls="addYacht" class="btn btn-white waves-effect waves-light" style="border-radius: 0px !important;color: #00365d;">
            <img src="/dashboard/assets/img/yacht-black.png" style="width: 20%" class="me-1" /> Add yacht </button>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="card" style="border: 1px solid #C6D2E7;height: 90px;box-shadow: none !important;background: url('/dashboard/assets/img/card-corner.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
            <div class="d-flex align-items-center">
              ...
              <div class="card-info">
                ...
                <h5 class="mb-0" style="color: #00365E">5 Feb</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-5">
              ...
              <label style="font-size: 18px;color: #00365E;padding-top: 3px;" class="me-2">Yacht list</label>
                ...
                <div class="input-group input-group-merge">
                 <span class="input-group-text" id="basic-addon-search31">
                  <i class="ti ti-search"></i>
                   ...
                   <input type="text" class="form-control" id="searchBar" placeholder="Search..." aria-label="Search..." aria-describedby="basic-addon-search31">
                </div>
              </div>
                <div class="col-lg-7">
          ...
          <div id="loader" style="display:none;position: fixed; top: 0; left: 0; width: 100%; height: 100%;background-color: rgba(255, 255, 255, 0.8); z-index: 1000; text-align: center; padding-top: 20%;">
            <img style="width:200px" src="/dashboard/assets/img/loader.gif" alt="Loading...">
          </div>

          <!-- Cards area -->
          <div id="yachtDataContainer">
...
<script>
  ...
  function doneTyping() {
    ...
    if (query) {
      // Perform the search by redirecting to a search page
  ...
  function fetchPage(page) {
    ...
    $.ajax({
      url: "/owner/yachet/fetch?page=" + page,
      type: "GET",
      dataType: "json",
      success: function(response) {
        console.log("ahad shapri",response);
        
        document.getElementById('loader').style.display = 'none';
        displayYachts(response.data.data);
  ...
  function displayYachts(yachts) {
    ...
    let container = document.getElementById('yachtDataContainer');
    container.innerHTML = '';

    yachts.forEach(yacht => {
      let yachtCard = `
        <div class="col-lg-12 mb-3 mt-5" style="border: 1px solid #C6D2E7;">
          <a href="/owner/yachets/overview/${yacht.id}" >
            <div class="row">
              <div class="col-lg-2">
                <img src="/storage/${yacht.image}" style="width: 100%;padding-top: 0px !important;" class="h-100">
              </div>
              <div class="col-lg-10 p-3">
                <div class="row">
                  <div class="col-lg-8" style="color:#00365E">
                    <div class="row">
                      <h4 style="font-size: 20px;color: #00365E;">${yacht.yachtName}</h4>
                      <div style="display: flex;margin-top: -15px;">
                        <span class="me-3 " style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">Mooring: <span style="color:#00365E">${yacht.mooringNumber}</span>
                        </span>
                        <span class="me-3 " style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">Size: <span style="color:#00365E">${yacht.yachtSize}</span>
                        </span>
                        <span class="me-3 " style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">Tonnage: <span style="color:#00365E">${yacht.yachtTonnage}</span>
                        </span>
                      ...
                      <div class="col-lg-10">
                        <div class="d-flex flex-wrap" style="text-align: left">
                          <div class="avatar me-3">
                            <img src="/user/images/cheif.png" alt="Avatar" class="rounded-circle">
                          </div>
                          <div>
                            <h6 class="mb-0">${yacht.yachtManufacturer}</h6>
                            <small>Captain</small>
                          </div>
                        </div>
                      </div>
  ...
  function setupPagination(data) {
    ...
    let prevLink = `
      <li class="page-item ${prevClass}">
        <a class="page-link" href="javascript:void(0)" onclick="fetchPage(${prevPage})" aria-label="Previous">
    ...
    for (let page = 1; page <= data.last_page; page++) {
      ...
      let pageLink = `
        <li class="page-item ${activeClass}">
          <a class="page-link" href="javascript:void(0)" onclick="fetchPage(${page})">${page}</a>
        </li>
      `;
    ...
    let nextLink = `
      <li class="page-item ${nextClass}">
        <a class="page-link" href="javascript:void(0)" onclick="fetchPage(${nextPage})" aria-label="Next">
