    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="activePlan" aria-labelledby="activePlan"
        ...
        <div class="offcanvas-body  mx-0 flex-grow-0">
            ...
            <div class="col-md-12 mb-4">
                <div class="d-flex flex-wrap">
                    ...
                    <p class="me-2" style="color: #00365E;font-size: 20px;margin-top: 14px;">My
                        yacht</p>
                    <div class="badge bg-label-primary rounded-pill " style="height: 25px;margin-top: 18px;">{{$yachts->count()}}</div>
                </div>
            </div>
            ...
            <div class="col-lg-12 mb-2" style="background-color: #F2F6FA;padding: 20px">
                <div class="row">
                    <div class="col-lg-6">
                        <p class="mb-0" style="color: #00365E;font-size: 16px;">{{$yacht->yachtName}}</p>
                    </div>
                    <div class="col-lg-6" style="text-align: right">
                        <div class="d-flex" style="float: right">
                            <i class="ti ti-ruler-2 ti-xs me-2"></i>
                            <p class="mb-0" style="font-size: 13px;color:#00365E">  {{$yacht->yachtSize}}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form role="form" action="{{ route('process-payment') }}" method="post" class="require-validation"
                ...
                <div class="form-row">
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" readonly='readonly' value="1200" id="amount" name="amount"
