		...
		<form id="jobForm" enctype="multipart/form-data" method="POST">
			...
			<div class="col-md-12 mb-4">
				<div class="input-group input-group-merge" style="border-radius: 0px !important">
					<select class="form-control" id="selectYacht" name="yacht_id" style="border-radius: 0px !important;">
			...
			<div class="col-md-12 mb-4">
				...
				<div class="input-group input-group-merge" style="border-radius: 0px !important">
					...
					<input type="date" class="form-control flatpickr-input" id="deliveryDate" name="delivery_date" value="<?php echo date('Y-m-d')?>" placeholder="YYYY-MM-DD">
