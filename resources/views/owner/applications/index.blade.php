...
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <form method="GET" action="{{ route('owner-applications.index') }}">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="createJob" aria-labelledby="createJob"
        ...
        <div class="offcanvas-body  mx-0 flex-grow-0">
            <div class="d-flex">
                <label class="badge bg-label-primary me-2" id="Underanalysis">
                    <i class="ti ti-eye me-1 ti-xs"></i>
                    <span>Under analysis</span>
                </label>
                <label class="badge bg-label-danger me-2" id="Refused">
                    <i class="ti ti-circle-x me-1 ti-xs"></i>
                    <span>Refused</span>
                </label>
                <label class="badge bg-label-success me-2" id="Hired">
            ...
            <h5 class="mt-3" id="job_title" style="color: #00365E;font-size: 20px;">The plastic on the roof needs
                ...
                winter</h5>
            <div class="d-flex">
                <span class="me-1" style="color:#5E8BF7;font-size:14px" id="jobid">#26789</span><i
                    class="ti ti-upload ti-xs me-2" style="color:#5E8BF7"></i>
                <div class="me-2" style="border-left: 1px solid #9CAFD1;height: 20px;"></div>
                <span style="color:#9CAFD1;font-size: 14px" id="yacht_name">Sunseeker Manhattan</span>
            </div>
            <div class="col-md-12 mb-4 mt-4">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="d-flex flex-wrap">
                            <div class="avatar me-3">
                                <img src="{{ asset('/dashboard/assets/img/profile.jpg') }}" alt="Avatar"
                    ...
                    <div class="col-lg-3">
                        <label class="badge mt-2" style="background:#5E8BF7;color:#fff"
                            id="profession">Professional</label>
                    </div>
                    <div class="col-lg-5 " style="text-align: right;">
                        <p class="mt-2" id="application_date" style="color:#9CAFD1;font-size: 14px;"><i
                                class="ti ti-calendar ti-xs me-2"></i>16 Jan 2023</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-12 mb-4">
                <p style="color: #00365E;font-size: 14px;"> </p>
            ...
            <div class="col-md-12 mb-2 p-2" style="border: 1px solid #C6D2E7;">
                <div class="row">
                    ...
                    <div class="col-lg-6" style="text-align: right">
                        <span style="color:#00365E " id="laborcost">15.500</span>
                    </div>
                </div>
            </div>
            <div class="col-md-12 mb-2 p-2" style="border: 1px solid #C6D2E7;">
                <div class="row">
                    ...
                    <div class="col-lg-6" style="text-align: right">
                        <span style="color:#00365E" id="materialcost">2.500</span>
                    </div>
                </div>
            </div>
        ...
        <div class="offcanvas-body  mx-0 flex-grow-0">
            ...
            <div class="col-md-12 mb-4 mt-4">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <label class="badge mt-2" style="background:#5E8BF7;color:#fff"
                            id="offer_title">Professional</label>
                    </div>
                    <div class="col-lg-5 " style="text-align: right;">
            ...
            <form id="next-offer-form" method="POST" action="{{ route('owner-offers.store') }}">
                @csrf
                @method('post')
                ...
                <div class="col-lg-12 mb-4">
                    <label style="color: #00365E;font-size: 16px;">Topics to change for the next offer</label>
                    <p class="mt-2" style="color: #00365E;font-size: 14px;">Select the topics that the professional
                        should consider to change in the next offer</p>
                </div>
                <div class="col-md-12 mb-2">
                    <div class="form-check mt-3">
                        <input class="form-check-input me-3" type="checkbox" name="topics[]" value="workplan"
                            id="check1">
                        <label class="form-check-label" for="check1" style="font-size: 14px;color: #00365E;">Workplan
                            not ideal</label>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input me-3" type="checkbox" name="topics[]" value="availability"
                            id="check2">
                        <label class="form-check-label" for="check2"
                            style="font-size: 14px;color: #00365E;">Availability - (too much to wait)</label>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input me-3" type="checkbox" name="topics[]" value="timeframe"
                            id="check3">
                        <label class="form-check-label" for="check3" style="font-size: 14px;color: #00365E;">Timeframe
                            - Job takes too long to be completed</label>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input me-3" type="checkbox" name="topics[]" value="cost"
                            id="check4">
                        <label class="form-check-label" for="check4" style="font-size: 14px;color: #00365E;">Cost - too
                            expensive. Either reduce the labor or material cost</label>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input me-3" type="checkbox" name="topics[]" value="payment_increase"
                            id="check5">
                        <label class="form-check-label" for="check5" style="font-size: 14px;color: #00365E;">Payment
                            options - Increase the installments quantity</label>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input me-3" type="checkbox" name="topics[]" value="payment_reduce"
                            id="check6">
                        <label class="form-check-label" for="check6" style="font-size: 14px;color: #00365E;">Payment
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tableRows.forEach(row => {
                row.addEventListener('click', function() {
                    ...
                    document.getElementById('application_date').textContent = created_at || 'N/A';
                    ...
                    document.getElementById('yacht_name').textContent = yachtname || 'N/A';
                    document.getElementById('profession').textContent = applicant_title || 'N/A';
                    document.getElementById('laborcost').textContent = labor_cost || 'N/A';
                    document.getElementById('materialcost').textContent = material_cost || 'N/A';
                    ...
                    const statusMapping = {
                        hired: 'Hired',
                        rejected: 'Refused',
                        'under analysis': 'Underanalysis',
                    };

                    const targetId = statusMapping[status?.toLowerCase()];
                    const ids = ['Hired', 'Refused', 'Underanalysis'];

                    ids.forEach(id => {
                        const element = document.getElementById(id);
                        if (element) {
                            element.style.visibility = id === targetId ? 'visible' :
                                'hidden';
                        }
                    });
            ...
            requestNewButton.addEventListener('click', function() {
                ...
                document.getElementById('offer_application_id').value = id;
                document.getElementById('offerjobdate').textContent = availability;

                document.getElementById('offer_title').textContent = applicant_title;
            ...
            const updateApplicationAndJobStatus = (applicationId, appStatus, jobId = null, jobStatus = null) => {
                ...
                fetch(`{{ route('owner-applications.update', ':id') }}`.replace(':id', applicationId), {
                        method: 'PUT',
                        headers: {
