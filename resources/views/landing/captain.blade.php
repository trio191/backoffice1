...
<body>
    ...
    <div class="hero pt-5 py-5 hero-height"
        style="background-image: url('landing/images/captians-hero.jpg'); height: 75vh; ">
        <div class="overlayb"></div>
        <div class="container   content">
            <div class="row align-items-center  justify-content-center ">
                <div class="col-lg-9 intro text-center">
                    <div class="container mx-auto px-4 py-20 text-center">
                        <h2 class="text-uppercase  py-2 subtitle-hero text-uppercase">For Owners & Captains</h2>
                        <h1 class=" text-uppercase mt-2 display-4 font-weight-bold  fs-2 hero-title">Own a superyacht
                            stress-free</h1>
                        <p class="mt-4 lead text-gray-300 hero-description">Discover all the benefits on a online
                            paltform</p>
        ...
        <div class="container ">
            <div class="row align-items-center">
                <div class="col-md-12  mx-auto">
                    <h5 class="sub-title pt-5">Owners and Captains centralized hub</h5>
                ...
                <div class="background-lines-cap px-0">
        ...
        <div class=" container-section2">
            <div class="text-center pb-12">
                ...
                <div class="mt-2 d-flex justify-content-center tabs-section2 flex-wrap flex-md-row">
                    <a href="#" class="big-feature-button ">for owners</a>
                    <a href="#" class="big-feature-button-Professionals ">for captain</a>
                </div>
            </div>
            <div class="row gap-4   cards-section justify-content-center">
                ...
                <div class="rounded-lg border bg-card text-card-foreground shadow-sm  p-6 mt-4 mb-2"
                    ...
                    <div class="flex-col space-y-1.5 p-6 flex items-center space-x-4"><svg width="22"
                            height="22" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="section5 big-section-captain  ">
        <div class="overlay"></div>
        <div class="container">
            <h6 class="section-title text-center  text-uppercase" style="font-family: Cormorant SC;">Register today
                and discover the simplicity,
                efficiency, and peace of mind that comes
                with our online platform.</h6>
            <p class="start-today">Start today and get 1 month free full access</p>
            <div class="card-container py-4 d-flex  gap-10 flex-wrap justify-content-center align-items-center  flex-md-row "
                style="gap: 20px">

                <div class="captain-card"
                    style="display: flex; justify-content: space-between; flex-direction: column; position: relative;">
                    <p class="description text-uppercase" style="z-index: 2;">Proud vessel owners</p>
                    <div class="bottom" style="z-index: 2;">
                        ...
                        <h3 class="title">I’m a <br />
                            Owners</h3>
                    </div>
                    <div class="captain-overlay"></div>
                </div>

                <div class="captain-card "
                    style="display: flex; justify-content: space-between; flex-direction: column; position: relative;">
                    <p class="description text-uppercase" style="z-index: 2;">trustworthy capitals and chief-engineers
                    </p>
                    <div class="bottom" style="z-index: 2;">
                        <div class="icon">
