            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        ...
                        <img src="/dashboard/assets/img/profile.jpg" alt class="h-auto rounded-circle" />

                        {{-- <img src="{{ asset('storage/' . Auth::user()->profile_image) }}" alt class="h-auto rounded-circle" /> --}}
                    ...
                    <li>
                        <a class="dropdown-item" href="#">
                            <center>
                                <div class="">
                                    <div class="avatar ">
                                        {{-- <img src="{{ asset('storage/' . Auth::user()->profile_image) }}" alt style="width: 50px;height: 50px;"  class="h-auto rounded-circle" /> --}}

                                         <img src="dashboard/assets/img/profile.jpg" alt
                                            class="h-auto rounded-circle" style="width: 50px;height: 50px;" />  
                                    </div>
                                    <label class="mt-3" style="color:#00365E;font-size: 16px;"> </label><br>
                                    <label style="font-size: 13px;color: #5E8BF7;">Admin</label>
                                </div>
                            </center>
                        </a>
                    </li>
