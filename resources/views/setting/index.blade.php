...
@section('content')
                ...
                <div class="nav-align-top  mb-4">
                    ...
                    <div class="tab-content" style="margin-left: -20px;margin-right: -20px">
                        <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                            <form method="POST" action="{{ route('update.owner.info', $user->id) }}"
                                        ...
                                        <div class="col-lg-12 mt-5" style="color: #00365E">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Last name"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter country*"
                                                            name="ownerDetails[country]"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="ownerDetails[postalCode]"
                                                            value=" {{ $ownerDetails['postalCode'] ?? '' }}">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control" placeholder="Enter Address"
                                                            style="border-radius:0px" name="ownerDetails[address]"
                                        ...
                                        <div class="card mb-2"
                                            ...
                                            <div class="d-flex"
                                                ...
                                                <input class="w-100" type="text" style="border: none !important"
                                                    placeholder="facebook URL" name="ownerDetails[facebookUrl]">
                                            </div>
                                            <div class="d-flex mt-2"
                                                style="border: 1px solid #C6D2E7;border-radius: 0px;background: #fff;text-align: left;padding: 10px;">
                                                <i class="ti ti-brand-linkedin ti-sm"></i>
                                                <input class="w-100" type="text" placeholder="LinkedIn URL"
                                                    style="border: none !important" name="ownerDetails[linkedinUrl]">
                                            </div>
                                        </div>
                                        <div class="card mb-2"
                                            style="border: 1px solid #C6D2E7;box-shadow: none !important;background: url('assets/img/card-corner2.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                                        ...
                                        <form method="POST" action="{{ route('update.owner.info', $user->id) }}">
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="1234" name="ownerDetails[postCode]"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="ownerDetails[companyRegVat]"
                                                            value="{{ $ownerDetails['companyRegVat'] ?? '' }}  "
                                                            >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px"
                                                            placeholder="Some street name and code" name="ownerDetails[address] "
                        ...
                        <div class="tab-pane fade" id="navs-top-permission" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="mt-3">
                                    <table class="table table-bordered table-responsive" style="color:#00365E">
                                        <!-- Header Row -->
                                        <thead>
                                            <tr style="font-size: 14px; text-align: center;">
                                                <th class="w-50"><strong>Permission</strong></th>
                                                <th><strong>Captain</strong></th>
                                                <th><strong>Chief Engineer</strong></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr style="font-size: 14px">
                                                ...
                                                <td class="text-center">
                                                    <label class="switch">
                                                        <input type="checkbox" class="switch-input"
                                                            data-role-id="{{ $roles->where('name', 'Captain')->first()->id }}"
                                                            data-permission-id="{{ $permission->id }}"
                                                            @if($roles->where('name', 'Captain')->first()->hasPermissionTo($permission->name)) checked @endif>
                                                        <span class="switch-toggle-slider">
                                                            <span class="switch-on"></span>
                                                            <span class="switch-off"></span>
                                                        </span>
                                                ...
                                                <!-- Chief Engineer Slider -->
                                                <td class="text-center">
                                                    <label class="switch">
                                                        <input type="checkbox" class="switch-input"
                                                            data-role-id="{{ $roles->where('name', 'Chief Engineer')->first()->id }}"
                                                            data-permission-id="{{ $permission->id }}"
                                                            @if($roles->where('name', 'Chief Engineer')->first()->hasPermissionTo($permission->name)) checked @endif>
                                                        <span class="switch-toggle-slider">
                                                            <span class="switch-on"></span>
                                                            <span class="switch-off"></span>
                                                        </span>
                                ...
                                <button class="btn mt-5" id="save-permissions" style="border-radius:0px;color:#fff;background:#5E8BF7">Update Permissions</button>
                            </div>
    ...
    document.getElementById('save-permissions').addEventListener('click', function () {
        if (changes.length > 0) {
            fetch('/update-multiple-permissions', {
                method: 'POST',
                headers: {
