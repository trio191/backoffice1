    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="activePlan" aria-labelledby="activePlan"
        ...
        <div class="offcanvas-body  mx-0 flex-grow-0">
            ...
            <div class="col-lg-12 mb-4"
                style="padding: 20px;background: url(assets/img/back2.png);background-size: 100% 100%;background-repeat: no-repeat;height: 150px;text-align: center;">
            ...
            <div class="col-lg-12 mb-4"
                style="padding: 20px;background: url(assets/img/back3.png);background-size: 100% 100%;background-repeat: no-repeat;height: 120px;text-align: center;">
