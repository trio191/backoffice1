                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-7" style="text-align: right;color: #00365E;">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="GET" action="{{ route('company.dashboard.myjobs') }}"
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('company.dashboard.myjobs', ['status' => 'Under Analysis']) }}">Under
                                                    Analysis</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('company.dashboard.myjobs', ['status' => 'Hired']) }}">Hired</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('company.dashboard.myjobs', ['status' => 'Rejected']) }}">Rejected</a>
                                            </li>
                                        </ul>

                                        <button type="button" class="btn " style="color: #9CAFD1;">
                                            <a href="{{ route('company.dashboard.myjobs') }}">Reset</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row mt-1"
                                    ...
                                    <div class="col-lg-5">
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <span style="font-size: 14px;"
                                                class=" budget bg-label-primary me-2">{{ $item->instalment }}</span>
