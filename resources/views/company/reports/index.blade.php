 ...
 @section('content')
     ...
     <div class="report-form" id="reportForm">
         <form action="{{ route('company-reports.store') }}" method="post" enctype="multipart/form-data">
             @csrf
             @method('post')
                     ...
                     <div class="col-lg-12">
                         <div class="row">
                             ...
                             <div class="col-lg-8" style="text-align: right;color: #00365E;">
                                 <div class="row">
                                     <div class="col-lg-5">
                                         <form method="GET" action="{{ route('company-reports.search') }}">
                                             @csrf
                                                     ...
                                                     @foreach ($report_types as $type)
                                                         <li>
                                                             <a class="dropdown-item"
                                                                 href="{{ route('company-reports.index', array_merge(request()->query(), ['report_type' => $type->id])) }}">
                                                                 {{ $type->name }}
                                                             </a>
                                                         </li>
                                                     @endforeach
                                             ...
                                             <div class="dropdown">
                                                 ...
                                                 <ul class="dropdown-menu">
                                                     @foreach ($jobs as $job)
                                                         <li>
                                                             <a class="dropdown-item"
                                                                 href="{{ route('company-reports.index', array_merge(request()->query(), ['yacht' => $job->yacht->id])) }}">
                                                                 {{ $job->yacht->yachtName }}
                                                             </a>
                                                         </li>
                                                     @endforeach
                                             ...
                                             <div class="dropdown">
                                                 ...
                                                 <ul class="dropdown-menu">
                                                     @foreach ($jobs as $job)
                                                         <li>
                                                             <a class="dropdown-item"
                                                                 href="{{ route('company-reports.search', ['job_id' => $job->id]) }}">
                                                                 {{ $job->job_title }}
                                                             </a>
                                                         </li>
                                                     @endforeach
                             ...
                             <table class="table table-responsive">
                                 ...
                                 @foreach ($reports as $item)
                                     <tr class="border" style="color:#00365E;font-size: 14px;">
                                         ...
                                         <td>
                                            <label class="badge 
                                                @if (optional($item->reportType)->name && strtolower($item->reportType->name) === 'incident')
                                                    bg-label-danger
                                                @else
                                                    bg-label-primary
                                                @endif">
                                                <span style="padding-top: 4px;">{{ optional($item->reportType)->name ?? 'N/A' }}</span>
                                            </label>
                                        </td>
