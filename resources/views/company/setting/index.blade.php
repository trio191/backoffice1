                ...
                <div class="nav-align-top  mb-4">
                    ...
                    <div class="tab-content" style="margin-left: -20px;margin-right: -20px">
                        <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                            <form method="POST" action="{{ route('company-settings.update', $user->id) }}"
                                        ...
                                        <div class="col-lg-12 mt-5" style="color: #00365E">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter Company Name"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter Company URL *"
                                                            name="companyDetails[companyUrl]" 
                                                            value="{{ $companyDetails['companyUrl'] ?? '' }}">
                                                        <label class="labelOwn">Company URL *</label>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter Company email *"
                                                            name="companyDetails[companyEmail]"
                                                            value="{{ $companyDetails['companyEmail'] ?? '' }}">
                                                        <label class="labelOwn">Company email *</label>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter Company number *"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <select class="form-control" style="border-radius:0px" name="companyDetails[numEmployees]">
                                                            <option disabled selected>Number of Employees</option>
                                                            <option value="1-10" {{ ($companyDetails['numEmployees'] ?? '') == '1-10' ? 'selected' : '' }}>1-10</option>
                                                            <option value="10-20" {{ ($companyDetails['numEmployees'] ?? '') == '10-20' ? 'selected' : '' }}>10-20</option>
                                                            <option value="20-50" {{ ($companyDetails['numEmployees'] ?? '') == '20-50' ? 'selected' : '' }}>20-50</option>
                                                            <option value="50-75" {{ ($companyDetails['numEmployees'] ?? '') == '50-75' ? 'selected' : '' }}>50-75</option>
                                                            <option value="75-100" {{ ($companyDetails['numEmployees'] ?? '') == '75-100' ? 'selected' : '' }}>75-100</option>
                                                            <option value="100-200" {{ ($companyDetails['numEmployees'] ?? '') == '100-200' ? 'selected' : '' }}>100-200</option>
                                                        </select>
                                                        <label class="labelOwn">Number of employees *</label>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter Company Address*"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter Company country*"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter State"
                                                            name="companyDetails[stateRegion]"
                                                            value="{{ $companyDetails['stateRegion'] ?? '' }}">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter City"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="Enter Postal Code"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control" placeholder="Enter Company RegVat"
                                                            style="border-radius:0px" name="companyDetails[companyRegVat]"
                                                            value=" {{ $companyDetails['companyRegVat'] ?? '' }}">
                                                        <label class="labelOwn">Company Registration or VAT</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <h4 style="color: #00365E;" class="mt-3 d-flex">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="number" class="form-control"
                                                            ...
                                                            name="companyDetails[experience]"

                                                            value="{{ $companyDetails['experience'] ?? '' }}"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="number" class="form-control"
                                                            style="border-radius:0px"
                                                            placeholder="Number of vehicles owned"  
                                                            name="companyDetails[vehicles]"
                                                            value="{{ $companyDetails['vehicles'] ?? '' }}"
                                                            >
                                                    </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <select class="form-control" style="border-radius:0px" name="companyDetails[workshop]">
                                                            <option disabled>Do you have your own workshop?</option>
                                                
                                                            <option value="yes" {{ isset($user->company['workshop']) && $user->company['workshop'] == 'yes' ? 'selected' : '' }}>Yes</option>
                                                            <option value="no" {{ isset($user->company['workshop']) && $user->company['workshop'] == 'no' ? 'selected' : '' }}>No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <select class="form-control" style="border-radius:0px" name="companyDetails[storage]">
                                                            <option disabled>Is the workshop used as storage?</option>
                                                
                                                            <option value="yes" {{ isset($user->company['storage']) && $user->company['storage'] == 'yes' ? 'selected' : '' }}>Yes</option>
                                                            <option value="no" {{ isset($user->company['storage']) && $user->company['storage'] == 'no' ? 'selected' : '' }}>No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <select class="form-control" id="defaultSelect" name="companyDetails[workshopsize]" style="border-radius: 0px">
                                                            <option disabled>Workshop size</option>
                                                
                                                            <option value="1-10" {{ isset($user->company['workshopsize']) && $user->company['workshopsize'] == '1-10' ? 'selected' : '' }}>1-10</option>
                                                            <option value="10-20" {{ isset($user->company['workshopsize']) && $user->company['workshopsize'] == '10-20' ? 'selected' : '' }}>10-20</option>
                                                            <option value="20-30" {{ isset($user->company['workshopsize']) && $user->company['workshopsize'] == '20-30' ? 'selected' : '' }}>20-30</option>
                                                            <option value="50-100" {{ isset($user->company['workshopsize']) && $user->company['workshopsize'] == '50-100' ? 'selected' : '' }}>50-100</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card mb-2"
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row mt-3" style="border-bottom: 1px solid #C6D2E7">
                                                    ...
                                                    <div class="col-lg-6" style="text-align: right;">
                                                        <p style="font-size: 14px;color:#00365E">
                                                            {{ $companyDetails['country'] ?? 'Not specified' }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="row mt-3" style="border-bottom: 1px solid #C6D2E7">
                                        ...
                                        <div class="card mb-2"
                                            ...
                                            <div class="d-flex"
                                                ...
                                                <input class="w-100" type="text" style="border: none !important"
                                                    placeholder="facebook URL" name="companyDetails[facebookUrl]">
                                            </div>
                                            <div class="d-flex mt-2"
                                                style="border: 1px solid #C6D2E7;border-radius: 0px;background: #fff;text-align: left;padding: 10px;">
                                                <i class="ti ti-brand-linkedin ti-sm"></i>
                                                <input class="w-100" type="text" placeholder="LinkedIn URL"
                                                    style="border: none !important" name="companyDetails[linkedinUrl]">
                                            </div>
                                        </div>
                                        <div class="card mb-2"
                                            style="border: 1px solid #C6D2E7;box-shadow: none !important;background: url('assets/img/card-corner2.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                                        ...
                                        <form method="POST" action="{{ route('company-settings.update', $user->id) }}"
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px" placeholder="1234" name="companyDetails[postCode]"
                                                            value="{{ $companyDetails['postCode'] ?? '' }}  "
                                                            >
                                                        <label class="labelOwn">Post Code</label>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="companyDetails[companyRegVat]"
                                                            value="{{ $companyDetails['companyRegVat'] ?? '' }}  "
                                                            >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group" style="position: relative;">
                                                        <input type="text" class="form-control"
                                                            style="border-radius:0px"
                                                            placeholder="Some street name and code" name="companyDetails[address] "
