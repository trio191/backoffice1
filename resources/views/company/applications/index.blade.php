                        ...
                        <div class="card"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-info">
                                    ...
                                    <h5 class="mb-0" style="color: #00365E">
                                        {{ $applications->where('status', 'Under Analysis')->count() }}
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-info">
                                    ...
                                    <h5 class="mb-0" style="color: #2AD7B3">
                                        {{ $applications->where(fn($application) => strtolower($application->status) === 'hired')->count() }}
                                    </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <form method="GET" action="{{ route('company-application.index') }}">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="d-flex flex-wrap">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('company-application.index', ['status' => 'Hired']) }}">Accepted</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('company-application.index', ['status' => 'Rejected']) }}">Rejected</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('company-application.index', ['status' => 'Under Analysis']) }}">Under
                                                            Analysis</a></li>
                                                </ul>
                                            </div>
                                            {{-- <div class="dropdown">
                                            ...
                                            <a href="{{ route('company-application.index') }}" class="btn waves-effect waves-light"
                                            style="color: #00365E;">
                                            All Jobs
                                        </a>
                            ...
                            <table class="table table-responsive">
                                ...
                                @foreach ($applications as $item)
                                    <tr class="border my-2" style="color:#00365E;font-size: 14px;">
                                        ...
                                        <td>
                                            <label class="badge 
                                            @if (strtolower($item->status) == 'hired') 
                                                bg-label-success
