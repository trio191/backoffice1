                ...
                <div class="row pt-2">
                    <div class="col-lg-7 text-white">
                        ...
                        <div class="d-flex flex-wrap" style="margin-top:-10px">
                            ...
                            <span class="d-flex align-items-center justify-content-center text-nowrap  vertical-line"
                                style="color:#00365E">
                                <i class="ti ti-calendar ti-xs me-2"></i>Posted on:{{ $job->created_at->format('d M Y') }} </span>
                            <span class="d-flex align-items-center justify-content-center text-nowrap  vertical-line"
                                style="color:#00365E">
                                <i class="ti ti-video ti-xs me-2"></i>Videos: {{ $job->video? 1: 0 }} </span>
                            <span class="d-flex align-items-center justify-content-center text-nowrap"
                                style="color:#00365E">
                                <i class="ti ti-photo ti-xs me-2"></i>Images: {{ $job->images? 1: 0 }}  </span>
                        </div>
                    </div>
                    <div class="col-lg-5" style="text-align: right;">
                        <button type="button" class="btn waves-effect waves-light"
                            ...
                            <button type="button" class="btn waves-effect waves-light"
                                style="border-radius: 0px !important; color: #00365E; background: #fff;">
                                Under analysis
                            </button>
                            <button type="button" class="btn waves-effect waves-light"
                                style="border-radius: 0px !important; color: #fff; background: #5E8BF7;" onclick="showForm()">
                                Apply for this job
                            </button>
                        @endif
            ...
            <div class="col-lg-12" style="margin-top: -24px">
                <div class="nav-align-top  mb-4">
                    ...
                    <div class="tab-content" style="margin-left: -20px;margin-right: -20px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="card mb-2"
                                        ...
                                        <span style="color:#00365E;font-size: 16px;">Yacht Size: 0 - {{ $job->yacht->yachtSize}}</span>
                                    </div>
                                    <div class="card mb-2"
                                        style="border: 1px solid #C6D2E7;box-shadow: none !important;background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                                        <span style="color:#00365E;font-size: 16px;">Manufatorer: {{ $job->yacht->yachtManufacturer }}</span>
                                    </div>
                                    <div class="card mb-2"
                                        style="border: 1px solid #C6D2E7;box-shadow: none !important;background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                                        <span style="color:#00365E;font-size: 16px;">Surveyor: {{ $job->require_surveyor}}</span>
                                    </div>
                                    <div class="card mb-2"
                                        style="border: 1px solid #C6D2E7;box-shadow: none !important;background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                                        ...
                                        <div class="d-flex flex-wrap">
                                          ...
                                          @foreach ($job->tags as $item)
                                            ...
                                            <label class="badge bg-label-primary me-2 mb-2"> {{$item->value}} </label>
                                          @endforeach
                                          @endif
                        ...
                        <!-- Form -->
                        <div id="slideForm">
                            <form method="post" action="{{route('company-application.store')}}" class="needs-validation" novalidate>
                              @csrf
                              @method('post')
                                <div class="mb-3">
                                    <input type="hidden" name="job_id" value="{{$job->id}}" id="">
                                    <label for="message" class="form-label">Message  </label>
                                    <textarea class="form-control" name="message" id="message" rows="3" placeholder="Why are you suitable for this job?"
                                        required></textarea>
                                ...
                                <div class="mb-3 form-check">
                                    <input type="checkbox" name="timeframe" class="form-check-input" id="timeframe" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="workplan" id="workplan" rows="3" placeholder="Please describe your work plan" required></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="number" name="laborCost" class="form-control" id="laborCost"
                                                placeholder="Enter Costs" required>
                                            <div class="invalid-feedback"> Please provide labor cost. </div>
                                        </div>
                                        <div class="col">
                                            <input type="number" name="materialCost" class="form-control" id="materialCost"
                                                placeholder="Enter Material cost" required>
                                            <div class="invalid-feedback"> Please provide material cost. </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 total-cost">
                                    <p>Total cost: <strong id="totalCost">0.0</strong>
                                    </p>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7" style="text-align: right;color: #00365E;">
                                                <div class="row">
                                                    <div class="col-3"></div>
                                                    <div class="col-lg-6">
                                                        <form class="input-group input-group-merge" method="GET" action="{{ route('company-jobs.show',$job->id) }}">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="d-flex flex-wrap">
                                                            <button type="button"
                                                                class="btn   waves-effect waves-light" aria-expanded="false"
                                                                style="color: #00365E;"> <a href="{{route('company-jobs.show',$job->id)}}">
                                                                Reset    
                                                                </a> </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-12 mt-4 mb-4">
                                            <table class="table table-responsive">
                                                ...
                                                <tr class="border p-4 text-center" style="color:#00365E;font-size: 14px;">
                                                ...
                                                <tr class="border" style="color:#00365E;font-size: 14px;">
                                                    <td>
                                                        <div class="d-flex flex-wrap">
                                                            ...
                                                            <span>{{$application->created_at->format('j M Y')}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex flex-wrap">
                                                            ...
                                                            <span style="font-size: 12px;padding-top: 4px;">{{$application->message}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex flex-wrap">
                                                            <i class="ti ti-coin me-1"></i>
                                                            <span style="font-size: 12px;padding-top: 2px;">{{$application->cost}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <label class="badge bg-label-primary">
                                                            <i class="ti ti-eye ti-xs me-1"></i>
                                                            <span style="padding-top: 4px;">{{$application->status}} </span>
                                                        </label>
                                                    </td>
                                                </tr>
                                                @endforeach
